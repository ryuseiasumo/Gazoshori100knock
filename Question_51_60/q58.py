    ...
    for y in range(H):
        for x in range(W):
            if _img[y][x] == 255:
                ...
                if r1 != 10000000000 or r2 != 10000000000:
                    label[y][x] = min(r1, r2)
                ...
                if r1 != 10000000000 and r2 != 10000000000:
                    r_not_select = max(r1, r2)
                    r_select = min(r1, r2)
                    label[label == r_not_select] = r_select
                    lookuptable[r_not_select] = r_select
    print(label[label > 0])
    print(lookuptable)
...
cv2.imwrite("./image_51_60/answer58.png", img_ans)
