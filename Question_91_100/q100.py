...
# read image
img = cv2.imread("./image_91_100/imori_1.jpg")
H, W, C = img.shape
...
img2 = cv2.imread("./image_91_100/imori_many.jpg")
H2, W2, C2 = img2.shape
...
for i in range(len(detects)):
    ...
    x = detects[i, -1]
    cv2.putText(img2, str(x) , (v[0], v[1]+9), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255,0,255), 1)

for g in GT:
    cv2.rectangle(img2, (g[0], g[1]), (g[2], g[3]), (0,255,0), 1)

cv2.imwrite("./image_91_100/answer_99.jpg", img2)
