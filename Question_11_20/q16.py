...
def sobel_fillter(_img, K_size = 3):
    img = _img.copy()
    pad = K_size//2
...
img_gray = Gray(img)
img_ans_v, img_ans_h = sobel_fillter(img_gray)

cv2.imwrite("./image_11_20/answer16_v.jpg", img_ans_v)
cv2.imwrite("./image_11_20/answer16_h.jpg", img_ans_h)
