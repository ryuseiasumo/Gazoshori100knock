...
def MorphologyDilate(_img2, count = 1):
    # H, W = img.shape
...
def MorphologyErode(_img2, count = 1):
    # H, W = img.shape
    # out = img.copy()
...
img1 = MorphologyDilate(edge)
img_ans = MorphologyErode(img1)

img_ans = img_ans.astype(np.uint8)
cv2.imwrite("./image_41_50/answer50.jpg", img_ans)
